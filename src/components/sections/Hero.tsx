        ...
        >
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400">
              O Padrão Industrial do Sudoeste
            </span>
          </div>
          ...
          <p className="text-xl text-zinc-500 mb-10 max-w-lg leading-relaxed font-light">
            Especialistas em <span className="font-bold text-formatto-black">Fachadas, Adesivos e Comunicação Visual</span>. Entregamos a maior fidelidade de cores e durabilidade para projetos que exigem o topo do mercado.
          </p>
          
          <div className="flex flex-wrap gap-5">
            <button className="btn-formatto flex items-center gap-3 group">
              SOLICITAR ORÇAMENTO AGORA
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="px-10 py-5 border-2 border-zinc-200 text-formatto-black font-bold hover:bg-zinc-50 transition-all uppercase text-xs tracking-widest">
              Ver Portfólio
            </button>
          </div>
          ...
          <div className="mt-16 grid grid-cols-2 gap-x-8 gap-y-4 pt-10 border-t border-zinc-100">
             {[
               "Adesivos de Alta Performance", "Lonas e Banners Gigantes", 
               "Fachadas em ACM e Letreiros", "Toldo Cortina e Coberturas",
               "Impressão UV de Cura Direta", "Corte de Precisão CNC"
             ].map((item, i) => (
               <div key={i} className="flex items-center gap-3">
                  <CheckCircle2 className="text-formatto-blue w-4 h-4" />
                  <span className="text-[11px] font-bold uppercase tracking-wider text-zinc-400">{item}</span>
               </div>
             ))}
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-8 shadow-[0_30px_60px_rgba(0,0,0,0.1)] border-b-8 border-formatto-yellow hidden md:block">
             <div className="text-center">
                <p className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.4em] mb-2">Compromisso Real</p>
                <p className="text-sm font-bold text-formatto-black">A MAIOR QUALIDADE E VELOCIDADE DA REGIÃO</p>
             </div>
          </div>
        </motion.div>
      </div>
